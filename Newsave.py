...
def draw_buttons():
    ...
    glBegin(GL_QUADS)
    # Save button
    glVertex2f(save_button_pos[0], save_button_pos[1])
    glVertex2f(save_button_pos[0] + button_width, save_button_pos[1])
    glVertex2f(save_button_pos[0] + button_width, save_button_pos[1] + button_height)
    glVertex2f(save_button_pos[0], save_button_pos[1] + button_height)
    # Load button
    glVertex2f(load_button_pos[0], load_button_pos[1])
    glVertex2f(load_button_pos[0] + button_width, load_button_pos[1])
    glVertex2f(load_button_pos[0] + button_width, load_button_pos[1] + button_height)
    glVertex2f(load_button_pos[0], load_button_pos[1] + button_height)
    glEnd()
    glColor3f(0.0, 0.0, 0.0)
    draw_text(save_button_pos[0] + 10, save_button_pos[1] + 10, "Save")
    draw_text(load_button_pos[0] + 10, load_button_pos[1] + 10, "Load")
...
def mouse_click(button, state, x, y):
    if button == GLUT_LEFT_BUTTON and state == GLUT_DOWN:
        if save_button_pos[0] <= x <= save_button_pos[0] + button_width and save_button_pos[1] <= window_height - y <= save_button_pos[1] + button_height:
            save_grid('grid_save.json')
        elif load_button_pos[0] <= x <= load_button_pos[0] + button_width and load_button_pos[1] <= window_height - y <= load_button_pos[1] + button_height:
            load_grid('grid_save.json')
